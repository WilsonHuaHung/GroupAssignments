...
**Installation:
1. Ensure you have Processing installed (download from processing.org).
2. Open the main sketch file (e.g., finalProject_main in Processing)
3. If you get a sound error. Go to sketch and download the "sound" library. This will remove the error and 4. allow the user to hear the music in the game.
